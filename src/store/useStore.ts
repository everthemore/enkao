...
export const useStore = create<AppState>((set, get) => ({
  ...
  getCalculatedActions: () => {
    ...
    plannedItems.forEach(plannedItem => {
      // Find all templates for this layer and knowledge item
      ...
      templates.forEach(template => {
        ...
        const scheduledEndDate = calculateValidDate(scheduledStartDate, template.durationDays - 1, events); // -1 because starting day counts as 1
